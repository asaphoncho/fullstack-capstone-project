        ...
        <div className="container mt-5">
            <div className="row justify-content-center">
                <div className="col-md-6">
                    ...
                    <input id="searchQuery" type='text' placeholder='Search for items...' className='form-control mb-2' onChange={(e) => setSearchQuery(e.target.value)} value={searchQuery}></input>
